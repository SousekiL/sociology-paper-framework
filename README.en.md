...
`library/` contains lawful public **metadata and available abstracts**, never full papers. Its update process is append-only and DOI-deduplicated: new scans enrich the archive and never overwrite accumulated records.
